...
Данные: NYC TLC Trip Record Data (Yellow, Green, FHV, FHVHV), 2019–2026. Очистка описана
в [`DATA_CLEANING_LOG.md`](DATA_CLEANING_LOG.md) (правила фильтрации по типу такси +
статистика по каждому обработанному файлу).
