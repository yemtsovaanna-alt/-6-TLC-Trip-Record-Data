...
> ноутбуке, только для своего раздела — Grafana-дашборды строились поверх этих локальных
> витрин. Витрины в репозиторий не входят (см. «Сквозной пайплайн» ниже), поэтому и сам
> Grafana-дашборд не поднимется на чужом устройстве. Вместо живой ссылки в репозитории
> оставлены фото и видео готовых дашбордов — ориентироваться по ним поможет карта ниже:
> дашборды стоит смотреть именно в том порядке, в котором они в ней перечислены.
