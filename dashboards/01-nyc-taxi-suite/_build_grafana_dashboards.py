...
относительно тренда — единственный округ, где объём упал год-к-году, на фоне роста везде
остальные.
...
**Короткий ответ:** рынок сжался с 4 игроков до фактической дуополии Uber/Lyft — Juno ушёл
...
Доминирование по зонам ещё жёстче: Uber — доминирующий агрегатор в 259 из 262 зон; три зоны,
где формально побеждает Lyft (Rikers Island, Governor's Island, кладбище Saint Michaels) —
статистический шум на почти нулевых объёмах, не реальные рыночные позиции. По типам такси
...
тем сильнее разъезд на такси. Полный отчёт: `reports/nyc_event_taxi_dowhy.html`.
